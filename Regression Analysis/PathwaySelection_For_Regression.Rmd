...
This code extracts genesets that we find interesting from previous analysis and plots and compares them. it also groups and saves the mto be put as inputs into further analysis and plotting. (for example corrolation heatmap)
