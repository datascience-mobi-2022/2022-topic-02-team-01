...
display.brewer.all(colorblindFriendly = TRUE)
library(ggplot2)
ggplot2::ggplot(data = Data, mapping = aes(x = Data[, 1], y = Data[, 2])) + geom_point(alpha = 0.9)+ aes(color=Data$Age) + scale_color_brewer(palette = "Paired") + ggtitle("BRCA Age") + xlab("1") + ylab("2")
saveRDS(Data, file="/Users/joana/Desktop/Data.RDS")

View(df.pw_aktivity_SkinnyBRCA)
View(df.umap_SkinnyBRCA_joint.RDS(1))
````