...
## This spesific Document:
This Document is meant to load the datasets, show analysis of the dimensions, and build some simople histograms etc with it.
...
This chunk makes copies of the datasets so ı dont fuck the original ones
...
This chunk makes locally saved copies of the datasets so we can call them with read functions
#DOESNT WORK

```{r copy datasets, echo=FALSE}
save(CancerHallmarkGenesetsList, file = "CancerHallmarkGenesetsList.rds")
save(TumorSpesificGenexpDatalist, file = "TumorSpesificGenexpDatalist.rds")
save(CancerGeneExpressionsRemixAnnots, file = "CancerGeneExpressionsRemixAnnots.rds")
save(CancerGeneExpressionsRemix, file = "CancerGeneExpressionRemix.rds")
head(CancerGeneExpressionsRemix)
```
