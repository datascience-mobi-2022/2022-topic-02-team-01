...
BRCAvsKIRC.df = rbind.fill(UP.ind1,  DOWN.ind1)
View(BRCAvsKIRC.df)
...
Pan_cancer_analysis.df = rbind.data.frame(BRCAvsKIRC.df, BRCAvsLUAD.df, BRCAvsPRAD.df, BRCAvsTHCA.df)
View(Pan_cancer_analysis.df)

saveRDS(Pan_cancer_analysis.df, file ="/Users/lunona/Desktop/BRCA/Pan_cancer_analysis.df.RDS")
```



```{r saving the dataframes}
# meged df: expression values, ensembl id, wether g is up or down 

#columns: Expression, ensembl, regulation is (up/down)
#rows: patients 
...
column3
UppersExpression1 == "UP"
DownersExpression1 == "DOWN"
UppersExpression2 == "UP"
DownersExpression2 == "DOWN"
UppersExpression3 == "UP"
DownersExpression3 == "DOWN"
UppersExpression4 == "UP"
DownersExpression4 == "DOWN"

 SkinnyBoy[(match(rownames(Uppers1), rownames(SkinnyBoy))), ]
genes_ens_SB

Pan_cancer_analysis.df = 
```
