...
readRDS("/Users/lunona/Desktop/BRCA/GitHub/2022-topic-02-team-01/genes_ensembl_SB.RDS")
readRDS("/Users/lunona/Desktop/BRCA/GeneNamesMetabolicPatsLit.RDS")
readRDS("/Users/lunona/Desktop/BRCA/genes_ensembl_SB.RDS")
readRDS("/Users/lunona/Desktop/BRCA/MetabolicsEnsembl.RDS")#this wrong this empty
readRDS("/Users/lunona/Desktop/BRCA/MetabolicEnsembl.rds")
```
...
for (m in 1:ncol(SkinnyBoy)){
  for (n in 1:46){
      MetabolicPathway_geneexp_list[[n]]= SkinnyBoy[match(unlist(MetabolicEnsembl$ID[n]),genes_ensembl_SB),m]
     banana = -match(unlist(MetabolicEnsembl$ID[n]),genes_ensembl_SB)
