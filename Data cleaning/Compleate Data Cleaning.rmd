...
BigSadBRCA = tcga_tumor_norm$BRCA$tumor
BigHappyBRCA = tcga_tumor_norm$BRCA$normal
...
```
now we have a list of ENSEMBL-ID's for our genes under the names genes_ensembl1 (BigSadBRCA) and genes_ensembl2 (BigHappyBRCA)
...
```
list_biotype1 and 2: The biotypes of the genes from our datasets (BigSadBRCA and HappyBRCA) genes that are found on ensembl database
...
BiotypeCleanedSadBRCA  = BigSadBRCA[matching1,]
BiotypeCleanedHappyBRCA = BigHappyBRCA[matching2,]
...
Finished varience filtering for BRCA datasets in this chunk
```{r cars}

#Variance 
variance1 = apply(BiotypeCleanedSadBRCA, 1, var)
variance2 = apply(BiotypeCleanedHappyBRCA, 1, var)

greater75.variance1 = SkinnySadBRCA[variance1 > quantile(variance1 , probs = 0.05), ]
greater75.variance2 = SkinnyHappyBRCA[variance2 > quantile(variance2, probs = 0.05), ]

dim(greater75.variance1)

SkinnySadBRCA = greater75.variance1
SkinnyHappyBRCA = greater75.variance2

saveRDS(SkinnySadBRCA, file = "C:/Users/EKN/Documents/GitHub/2022-topic-02-team-01/SkinnySadBRCA.RDS") 
saveRDS(SkinnyHappyBRCA, file = "C:/Users/EKN/Documents/GitHub/2022-topic-02-team-01/SkinnyHappyBRCA.RDS") 
...
_____________________________________________________________________________________________________________________________________
ONLY JUNK ROWS BELOW DO NOT RUN THEM
_____________________________________________________________________________________________________________________________________
Select rows where variance is bigger than 75 percent (Interesting values)
```{r cars}
...
matchingBRCA1 = match(rownames(greater75.variance1), rownames(SkinnySadBRCA))
matchingBRCA1 # a vector with the row numbers of Bigboy Dataset that needs to be removed


matchingBRCA2 = match(rownames(greater75.variance2), rownames(SkinnyHappyBRCA))
matchingBRCA2 # a vector with the row numbers of Bigboy Dataset that needs to be removed
...
SkinnySadBRCA = SkinnySadBRCA[Vector[-matchingBRCA1],]
SkinnyHappyBRCA = SkinnyHappyBRCA[Vector[-matchingBRCA2],]
